        ...
        <div class="row ftco-animate">
            <div class="col-md-12">
                <div class="carousel-testimony owl-carousel">
                    ...
                    <div class="more">
                        <button class="circle" data-toggle="modal" data-target="#modal-avaliacao" title="Adicionar avaliação">
...
<div class="modal fade" id="modal-avaliacao" tabindex="-1" aria-labelledby="avaliacaoLabel" aria-hidden="true" data-backdrop="static">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <form id="formAvaliacao" action="processa.php" method="post">                 
